...
class Decoder(nn.Module):
    ...
    def forward(self, trg_embeddings_batch, src_representations_batch, trg_mask, src_mask):
        ...
        for decoder_layer in self.decoder_layers:
            ...
            trg_representations_batch = decoder_layer(
                trg_representations_batch, src_representations_batch, trg_mask, src_mask
            )
...
class DecoderLayer(nn.Module):
    ...
    def forward(self, trg_representations_batch, src_representations_batch, trg_mask, src_mask):
        ...
        decoder_trg_self_attention = lambda trb: self.trg_multi_headed_attention(
            query=trb, key=trb, value=trb, mask=trg_mask
        )
        decoder_src_attention = lambda trb: self.src_multi_headed_attention(

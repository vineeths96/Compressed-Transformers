...
This project is built upon an existing transformer implementation from [Aleksa Gordic](https://github.com/gordicaleksa/pytorch-original-transformer). The README from the original repository follows below the line. 
